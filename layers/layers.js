...
lyr_Mes_pointswaypoints_2.set('fieldLabels', {'name': 'inline label', 'elevation': 'inline label', 'comment': 'no label', 'description': 'header label', 'source': 'no label', 'url': 'no label', 'url name': 'no label', });
